...
def train(model, trainloader, criterion, optimizer, device, epoch, hook):
...
def test(model, testloader, criterion, device, hook):
...
def main(args):
    ...
    for epoch in range(1, args.epochs +1 ):
        ...
        model=train(model, trainloader, loss_criterion, optimizer, device, epoch, hook)
